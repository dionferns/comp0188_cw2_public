from jaxtyping import jaxtyped, Int,Float, Array
...
def to_greyscale(
    c_img: Int[Array, "batch_size, row_pixels, col_pixels, filters"],  # Input: Integer NumPy array
) -> Float[Array, "batch_size, row_pixels, col_pixels"]:      # Output: Float NumPy array
